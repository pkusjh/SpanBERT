...
if __name__ == "__main__":
        ...
        parser.add_argument("--data_cache_dir", default=None, type=str,
                            help="The data cache dir. If ***_dataset.pt exist in cache dir, they will be loaded directly. Otherwise, dataset will be constructed and stored in the cache dir (if not None)")
